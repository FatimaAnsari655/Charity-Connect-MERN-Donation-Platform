      ...
      <div style={{ overflowX: "auto" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #dee2e6" }}>
          ...
          <tbody>
            {items.map((d) => (
              <tr key={d._id}>
                <td style={{ padding: "12px", border: "1px solid #dee2e6" }}>{d.donor}</td>
                <td style={{ padding: "12px", border: "1px solid #dee2e6" }}>{d.category}</td>
                <td style={{ padding: "12px", border: "1px solid #dee2e6" }}>
                  {d.amount ? `$${d.amount}` : "N/A"}
                </td>
                <td style={{ padding: "12px", border: "1px solid #dee2e6" }}>{d.message}</td>
                <td style={{ padding: "12px", border: "1px solid #dee2e6" }}>
